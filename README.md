...
- Each player rolls 2 dice, and earns or loses points depending on the sum.
- There are 3 types of players: type 1 players win points if the sum of the dice is 6, 7, 8 or 9, type 2 players win points
...
2 wins almost as often as player 1, they get far less points since 6, 7, and 8 are some of the most common sums, and player type 2 gets those subtracted. So the more rounds per game, the less likely 
